...
class tempo_computacional_tf():
    def calculate_tempo_computacional_h_t():
        ...
        material_list = ['Cobre', 'Aço Inoxidável AISI 316']
        rho_list = [8.92, 8.238]  # g/cm³
        ...
        for solver_idx, solver in enumerate(solvers):  # enumerate adiciona um contador à iteração
            ...
            for n_t_idx, delta_t in enumerate(n_t_array_gs_cobre):  # enumerate adiciona um contador à iteração
                ...
                tabela.add_row(
                    [n_x, delta_t_rounded, solver, rounded_value_cobre, rounded_value_al])
        ...
        return tempo_total_array_tf_gs_cobre,  tempo_total_array_tf_tdma_cobre, tempo_total_array_tf_jac_cobre, tempo_total_array_tf_gsr_cobre, tempo_total_array_tf_solv_cobre, n_t_array_gs_cobre, n_t_array_gs_al,\
            n_t_array_tdma_cobre, n_t_array_tdma_al, n_t_array_jac_cobre, n_t_array_jac_al, n_t_array_gsr_cobre, n_t_array_gsr_al, n_t_array_solv_cobre, n_t_array_solv_al, n_x, \
    ...
    def calculate_tempo_computacional_h_x():
        ...
        for solver_idx, solver in enumerate(solvers):  # enumerate adiciona um contador à iteração
            ...
            for n_x_idx, delta_x in enumerate(n_x_array_gs_cobre):  # enumerate adiciona um contador à iteração
                ...
                tabela.add_row(
                    [n_t, delta_x_rounded, solver, rounded_value_cobre, rounded_value_al])

        print(tabela)


        return tempo_total_array_tf_gs_cobre,  tempo_total_array_tf_tdma_cobre, tempo_total_array_tf_jac_cobre, tempo_total_array_tf_gsr_cobre, tempo_total_array_tf_solv_cobre, n_x_array_gs_cobre, \
            n_x_array_gs_al, n_x_array_tdma_cobre, n_x_array_tdma_al, n_x_array_jac_cobre, n_x_array_jac_al, n_x_array_gsr_cobre, n_x_array_gsr_al, n_x_array_solv_cobre, n_x_array_solv_al, n_t, \
            tempo_total_array_tf_gs_al,  tempo_total_array_tf_tdma_al, tempo_total_array_tf_jac_al, tempo_total_array_tf_gsr_al, tempo_total_array_tf_solv_al
...
tempo_total_array_tf_gs_cobre,  tempo_total_array_tf_tdma_cobre, tempo_total_array_tf_jac_cobre, tempo_total_array_tf_gsr_cobre, tempo_total_array_tf_solv_cobre, n_x_array_gs_cobre, \
            n_x_array_gs_al, n_x_array_tdma_cobre, n_x_array_tdma_al, n_x_array_jac_cobre, n_x_array_jac_al, n_x_array_gsr_cobre, n_x_array_gsr_al, n_x_array_solv_cobre, n_x_array_solv_al, n_t, \
