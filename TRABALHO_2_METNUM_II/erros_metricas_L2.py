...
class erros_tt_ftcs():
    def calculate_erros_tempo():
        ...
        for i in range(len(T_calc_array)): # acesso a matriz menor
            ...
            T_ex = T_ex_array[i]
            sum = 0
            y_calc = T_calc[:, 15] # selecinar a coluna
            y_ex = T_ex[:, 15] # selecinar a coluna
    ...
    def calculate_erros_malha():
        ...
        for i in range(len(T_calc_array)):  # acesso a matriz menor
            ...
            T_ex = T_ex_array[i]
            sum = 0
            y_calc = T_calc[500]  # selecinar a coluna
            y_ex = T_ex[500]  # selecinar a coluna
            n_x = n_x_array[i]
...
class erros_tt_btcs():
    ...
    def calculate_erros_malha():
        ...
        for i in range(len(T_calc_array)):  # acesso a matriz menor
            ...
            T_ex = T_ex_array[i]
            sum = 0
            y_calc = T_calc[526]  # selecinar a coluna
            y_ex = T_ex[526]  # selecinar a coluna
            n_x = n_x_array[i]
            for k in range(1, len(y_ex)):  # acesso a cada linha
                sum = sum + ((abs((y_ex[k] - y_calc[k]) / (y_ex[k]))) ** 2)
            L2 = np.sqrt((1 / (n_x ** 2)) * sum)
...
for n_t_val, L2_tt_ftcs_val, L2_tt_btcs_val, L2_tt_cn_val, err_rel_tt_ftcs_val, err_rel_tt_btcs_val, err_rel_tt_cn_val, E_inf_tt_ftcs_val, E_inf_tt_btcs_val, E_inf_tt_cn_val in zip(n_t_array, L2_list_tempo_tt_ftcs, L2_list_tempo_tt_btcs, L2_list_tempo_tt_cn, err_rel_total_list_tempo_tt_ftcs, err_rel_total_list_tempo_tt_btcs, err_rel_total_list_tempo_tt_cn, E_inf_depois_list_tempo_tt_ftcs, E_inf_depois_list_tempo_tt_btcs, E_inf_depois_list_tempo_tt_cn):
    ...
    tabela.add_row([n_x, rounded_n_t_val, rounded_L2_tt_ftcs_val, rounded_L2_tt_btcs_val, rounded_L2_tt_cn_val, rounded_err_rel_tt_ftcs_val, rounded_err_rel_tt_btcs_val, rounded_err_rel_tt_cn_val, rounded_E_inf_tt_ftcs_val, rounded_E_inf_tt_btcs_val, rounded_E_inf_tt_cn_val])
...
for n_x_val, L2_tt_ftcs_val, L2_tt_btcs_val, L2_tt_cn_val, err_rel_tt_ftcs_val, err_rel_tt_btcs_val, err_rel_tt_cn_val, E_inf_tt_ftcs_val, E_inf_tt_btcs_val, E_inf_tt_cn_val in zip(n_x_array, L2_list_malha_tt_ftcs,
                                                   L2_list_malha_tt_btcs, L2_list_malha_tt_cn, err_rel_total_list_malha_tt_ftcs,
                                                                           err_rel_total_list_malha_tt_btcs, err_rel_total_list_malha_tt_cn, E_inf_depois_list_malha_tt_ftcs, E_inf_depois_list_malha_tt_btcs, E_inf_depois_list_malha_tt_cn):
    rounded_L2_tt_ftcs_val = round(L2_tt_ftcs_val, 4)
    rounded_L2_tt_btcs_val = round(L2_tt_btcs_val, 4)
    rounded_L2_tt_cn_val = round(L2_tt_cn_val, 4)
    rounded_err_rel_tt_ftcs_val = round(err_rel_tt_ftcs_val, 4)
    ...
    tabela.add_row([n_t, rounded_n_x_val, rounded_L2_tt_ftcs_val, rounded_L2_tt_btcs_val, rounded_L2_tt_cn_val, rounded_err_rel_tt_ftcs_val, rounded_err_rel_tt_btcs_val, rounded_err_rel_tt_cn_val, rounded_E_inf_tt_ftcs_val, rounded_E_inf_tt_btcs_val, rounded_E_inf_tt_cn_val])

print(tabela)

# Comparando os erros dos Métodos:
cores = ['#C71585', '#32CD32', '#4682B4']

plt.plot(n_t_array, L2_list_tempo_tt_ftcs, linestyle='dashed', color=cores[0], label='FTCS')
plt.plot(n_t_array, L2_list_tempo_tt_btcs, linestyle='dashed', color=cores[1], label='BTCS')
plt.plot(n_t_array, L2_list_tempo_tt_cn, linestyle='dashed', color=cores[2], label='CN')
...
plt.plot(n_x_array, L2_list_malha_tt_ftcs, linestyle='dashed', color=cores[0], label='FTCS')
plt.plot(n_x_array, L2_list_malha_tt_btcs, linestyle='dashed', color=cores[1], label='BTCS')
plt.plot(n_x_array, L2_list_malha_tt_cn, linestyle='dashed', color=cores[2], label='CN')
