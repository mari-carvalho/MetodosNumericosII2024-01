...
for n_t_val, L2_tt_ftcs_val, L2_tt_btcs_val, L2_tt_cn_val, err_rel_tt_ftcs_val, err_rel_tt_btcs_val, err_rel_tt_cn_val in zip(n_t_array, L2_list_tempo_tt_ftcs, L2_list_tempo_tt_btcs, L2_list_tempo_tt_cn, err_rel_total_list_tempo_tt_ftcs, err_rel_total_list_tempo_tt_btcs, err_rel_total_list_tempo_tt_cn):
    ...
    tabela.add_row([n_x, rounded_n_t_val, rounded_L2_tt_ftcs_val, rounded_L2_tt_btcs_val, rounded_L2_tt_cn_val, rounded_err_rel_tt_ftcs_val, rounded_err_rel_tt_btcs_val, rounded_err_rel_tt_cn_val])
...
for n_x_val, L2_tt_ftcs_val, L2_tt_btcs_val, L2_tt_cn_val, err_rel_tt_ftcs_val, err_rel_tt_btcs_val, err_rel_tt_cn_val in zip(n_x_array, L2_list_malha_tt_ftcs,
    ...
    tabela.add_row([n_t, rounded_n_x_val, rounded_L2_tt_ftcs_val, rounded_L2_tt_btcs_val, rounded_L2_tt_cn_val, rounded_err_rel_tt_ftcs_val, rounded_err_rel_tt_btcs_val, rounded_err_rel_tt_cn_val])
